...
export const posts = [
  {
    ...
    priority: 'High',
    type: 'local',
    route: '/posts/is-your-website-built-for-ai-agents',
    author: {
      name: 'Tech Notes',
      role: 'AI & Web Architecture Explainer',
      initials: 'TN',
    },
    hero: {
      eyebrow: 'AI Agents & Web Standards',
      summary:
        'Websites are typically built for human users, but AI agents increasingly interact with the same interfaces. Semantic HTML and accessibility attributes provide the context agents need to understand and act reliably.',
    },
  },
  ...
  },
  {
    ...
    hero: {
      ...
      summary: 'Beyond the Prompt: A Beginner’s Guide to Context Engineering.',
    },
  },
  {
  ...
  },
  {
    ...
    priority: 'High',
    type: 'local',
    route: '/posts/structured-formats-for-effective-ai-agent-skills',
    author: {
      name: 'Tech Notes',
      role: 'AI Architecture Explainer',
      initials: 'TN',
  ...
  {
    title:
      'The Engine Behind Autonomous AI: Agents, Harnesses, and Autoresearch',
  ...
  {
    title:
      'The 1-Hour Next.js Build: How OpenTelemetry Shined a Light on CI/CD Bottlenecks',
