...
export const articleRegistry = {
  ...
  "react-server-components-aggregation-layer":
    ReactServerComponentsAggregationArticle,
  ...
  "engine-behind-autonomous-ai-agents-harnesses-autoresearch":
    EngineBehindAutonomousAiArticle,
